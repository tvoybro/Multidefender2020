	...
	while (krujFrm < (isNtsc ? 48 : 46))
	{
			...
			if (++krujPalId == 3) {
				...
				if (krujAnimaLenId < 43) {
					for (i = 0; i < krujAnimaLen[krujAnimaLenId]; i++) {
						one_vram_buffer(krujAnimaChr[krujAnimaId][2], 256 * krujAnimaChr[krujAnimaId][0] + krujAnimaChr[krujAnimaId][1]);
						one_vram_buffer(krujAnimaChr[krujAnimaId][2], 256 * krujAnimaChr[krujAnimaId][0] + krujAnimaChr[krujAnimaId][1] + 13);
						++krujAnimaId;
					}
					++krujAnimaLenId;
				}
		...
		if (krujWait == 1 && krujAnimaLenId < 43) {
			...
			for (i = 0; i < krujAnimaLen[krujAnimaLenId]; i++) {
				...
				spr = oam_spr(
					krujAnimaSpr[krujAnimaId+i][3], //x
					krujAnimaSpr[krujAnimaId+i][0]-1, //y
					krujAnimaSpr[krujAnimaId+i][1], //spr
					krujPalId + krujAnimaSpr[krujAnimaId+i][2], //attr
					spr
				);
				spr = oam_spr(
					krujAnimaSpr[krujAnimaId+i][3]+104, //x
					krujAnimaSpr[krujAnimaId+i][0]-1, //y
					krujAnimaSpr[krujAnimaId+i][1], //spr
					krujPalId + krujAnimaSpr[krujAnimaId+i][2], //attr
					spr
