...
.endif
	...
	.include "Include/neslib.sinc"
	.include "Include/nesdoug.sinc"

.segment "RODATA"

music_data:
	.include "Music/music.sinc"

.if(FT_SFX_ENABLE)
sounds_data:
	.include "Music/sounds.sinc"
.endif
